 ...
 * 	ex) http / https - 웹서버 프로토콜 (회사에서 보안상 프로토콜을 규정할 수도 있음)
 *  ftp - 파일서버 프로토콜 
 *  mailto - 전자메일 서버 프로토콜
 *  telnet - 원격접속 프로토콜
 *  
 * https://n.news.naver.com:443/article/138/0002156622?cds=news_media_pc&type=editn
 * 
 * 호스트(host)
 * 	리소스가 위치한 서버의 이름
 * 	ex) n.news.naver.com 
 ...
 * 	ex) /article/215/0001125423  (예전에는 정말 파일 디렉토리 단위였지만 요즘은 method 추상 경로)
 * 
 * 쿼리(query) - 파라미터 
 * 	추가로 서버에 보내는 데이터 (물음표 뒤에 있는 정보)
 * 
 * 
 */
