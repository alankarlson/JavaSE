...
import java.util.ArrayList; // ArrayList를 실무에서 제일 많이 씀
...
public class Collection02 {
	public static void main(String[] args) {
		...
		String pokemon2 = list.get(1);
		System.out.println("list 1 인덱스 값: " + pokemon2);
		
		// 지정된 데이터 인덱스 값으로 삭제
		list.remove(1);
		System.out.println("=============================");
		System.out.println("저장된 데이터 개수: " + list.size());
		String pokemon3 = list.get(1);
		System.out.println("list 1 인덱스 값: " + pokemon3);
		 ...
		 * 	ArrayList와 동일
		 * 	Thread safe
		 * 	**여러 thread가 동시에 접근해야할때 사용, 동기화해야해서 성능은 떨어짐
		 * 
		 */
