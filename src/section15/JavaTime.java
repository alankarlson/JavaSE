...
public class JavaTime {
	public static void main(String[] args) {
		...
		// 특정 날짜와 시간 생성
		LocalDateTime spicificDateTime = LocalDateTime.of(2023, Month.JANUARY, 1, 12, 0);
		System.out.println("Specific Date and Time: " + spicificDateTime );
		...
		System.out.println("Formattd Date: " + formattedDate);
