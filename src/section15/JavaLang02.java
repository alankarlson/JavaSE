 ...
 * 
 * 2. 깊은복사(Deep Copy)
 * 	- 객체의 멤버변수 값과 객체가 참조하는 객체까지 모두 복사하는 방식.
 * 	- 새로운(다른) 객체를 참조하게 된다.
 * 
 */
...
public class JavaLang02 {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		if(sTeam1.equals(sTeam2)) {
			System.out.println("sTeam1과 sTeam2는 같습니다.");
		} else {
			System.out.println("sTeam1과 sTeam2는 다릅니다.");
		}
		
		if(sTeam1.equals(sTeam3)) {
			System.out.println("sTeam1과 sTeam3은 같습니다.");
		} else {
			System.out.println("sTeam1과 sTeam3은 다릅니다.");
		}
