 ...
 * 
 *  변수 선언 및 초기화
 *  자료형(Type) 변수명 = 값(기본형 변수일 때) or 객체 참조값(참조형 변수일 때); 
 *  
 *  1. 타입에 따른 변수
 *  	기본형 - 예약어, 소문자로 시작, 직접 값을 가지고 있다.
 *  		8가지 - boolean, char, byte, short, long, int, float, double
 *  
...
public class Var01 { 
	...
	static int globalNum2;  // 변수선언 초기화 하지 않음, 그래도 디폴트값 들어감
	 
	public static void main(String[] args) {
		int areaNum2; // 변수선언 초기화 하지 않음 , 초기화 안하면 에러 남
		areaNum2 = 0;
